...
class TaskManager(object):
    ...
    def __init__(
        ...
        **kwargs: Unpack[TaskManagerProps],
        ...
        self._exploration_strategy._inject_deps(self._old_retrival,self._llm_client,DashScopeClient(model_name='qwen3-235b-a22b-instruct-2507',max_tokens=8192),user_profile=user_profile)  # ⭐ Inject dependencies into the exploration strategy
